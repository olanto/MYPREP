...
public class RUNBuildEvalTuning {


    public static void main(String[] args) {
        if (args.length < 4) {
            String syntax = "Error int parameters:RUNBuildEvalTuning maxtuning maxeval step root" ;
            ...
            String root=args[3];
               BuildEvalTuning.extract(root, maxtuning, maxeval, step);
        }
    }
